/**
 * Phase 1 안건 중심 케이스 — AgendaCase 목록
 *
 * 각 AgendaCase는 제갈량이 안건을 제시하고, 관우·미축·방통이
 * 각자의 관점(군사·내정·외교)에서 안건에 연계 반응하는 구조.
 * 우선순위(priority) 높은 케이스부터 조건 확인 후 1개 채택.
 */

import type { AgendaCase } from "./types";
import { getWallUpgradeCost, RECRUIT_TROOPS_PER_IP } from "@/constants/gameConstants";

export const ALL_AGENDA_CASES: AgendaCase[] = [

  // ────────────────────────────────────────────────────────
  // priority 90: 직전 전투 패배
  // ────────────────────────────────────────────────────────
  {
    id: "after_battle_lost",
    priority: 90,
  ...
  // ────────────────────────────────────────────────────────
  // priority 80: 적이 본성 인근
  // ────────────────────────────────────────────────────────
  {
    id: "capital_under_threat",
    priority: 80,
  ...
  // ────────────────────────────────────────────────────────
  {
    ...
    responses: {
      ...
      "미축": [
        {
          dialogue: (s) => `은행 레벨을 올리면 한도가 늘어납니다. 지금 당장 은행 업그레이드를 하면 자원 손실 없이 더 많이 비축할 수 있습니다.`,
          emotion: "thoughtful",
        },
        {
          dialogue: (s) => `시장이나 농장 업그레이드도 좋은 투자입니다. 넘치는 내정력을 시설 강화에 쓰면 앞으로 수입도 늘어납니다.`,
          emotion: "calm",
        },
      ],
      "방통": [
  ...
  // ────────────────────────────────────────────────────────
  // priority 50: 공세 기회 (내 MP > 적 MP × 1.5)
  // ────────────────────────────────────────────────────────
  {
    id: "attack_opportunity",
    priority: 50,
    condition: (s) => {
      const weakest = s.strategic.weakestEnemy;
      return !!weakest && s.military.mp > weakest.mp * 1.5;
    },
    opening: [
      {
  ...
  // ────────────────────────────────────────────────────────
  // priority 40: 훈련도 저조 (< 50%)
  // ────────────────────────────────────────────────────────
  {
    id: "low_training",
    priority: 40,
    condition: (s) => s.military.lowTraining,
    opening: [
      {
  ...
  // ────────────────────────────────────────────────────────
  // priority 35: 수입 저조 (ipRegen <= 10)
  // ────────────────────────────────────────────────────────
  {
    id: "income_low",
    priority: 35,
    condition: (s) => s.economy.ipRegen <= 10 && !s.economy.lowIncome,
    opening: [
      {
    ...
    responses: {
      "관우": [
        {
          dialogue: (s) => `군사비도 결국 내정에서 나옵니다. 수입이 늘어야 더 강한 군대를 유지할 수 있습니다. 내정 강화를 지지합니다.`,
          emotion: "calm",
        },
        {
  ...
  // ────────────────────────────────────────────────────────
  // priority 25: 우리가 적 본성 인근 (공세 기회)
  // ────────────────────────────────────────────────────────
  {
    id: "near_enemy_capital",
    priority: 25,
    condition: (s) => s.strategic.nearEnemyCapital && !s.strategic.enemyNearCapital,
    opening: [
      {
  ...
  // ────────────────────────────────────────────────────────
  // priority 5: 기본 — 현상 유지 및 점진 발전 (항상)
  // ────────────────────────────────────────────────────────
  {
    id: "general_default",
    priority: 5,
