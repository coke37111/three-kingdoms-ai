...
export function buildDialogueVariables(
  ...
  if (econ.canUpgradeMarket) {
    ...
    buildAdvice = `농장 건설(비용 ${econ.farmBuildCost}) 즉시 가능`;
  } else {
    ...
    buildAdvice = `내정포인트 ${Math.min(...opts)} 필요 (현재 ${econ.ip})`;
  }
...
export const ZHUGE_TEMPLATES: Partial<TemplateMap> = {
  ...
  strategic_overview: {
    comfortable: [
      { text: "주공, 현재 천하 정세가 우리에게 유리합니다. 군사포인트 {playerMP}으로 {threatName}의 {threatMP}을 크게 앞서고 있사옵니다." },
      { text: "형세가 밝습니다. 병력 {playerTroops}에 내정 수입 {ipRegen}으로 안정된 기반이 갖추어져 있습니다." },
    ],
    stable: [
      { text: "주공, 정세는 대체로 안정적입니다. 군사포인트 {playerMP}, 내정 수입 {ipRegen}으로 내실을 기하고 있사옵니다." },
    ],
    adequate: [
      { text: "주공, 정세가 균형을 이루고 있습니다. 우리 군사포인트 {playerMP}, {threatName}의 군사포인트 {threatMP}이옵니다." },
      { text: "현 정세는 판가름이 나지 않았습니다. {castleCount}개 성채에 병력 {playerTroops}, 내정 수입 {ipRegen}이옵니다." },
    ],
    uneasy: [
      { text: "주공, 정세가 불안합니다. {threatName}의 군사포인트 {threatMP}에 비해 우리는 {playerMP}으로 다소 열세입니다." },
    ],
    crisis: [
      { text: "주공, 위기입니다. {threatName}의 군사포인트 {threatMP}에 비해 우리는 {playerMP}에 불과하옵니다. 인접 {adjacentEnemyCount}개 성에서 위협받고 있습니다." },
      { text: "주공, 사태가 심각합니다. {threatName}과의 관계는 {threatRelationLabel}, 군사포인트 비율은 {mpRatioPercent}%에 불과합니다." },
    ],
    critical: [
      { text: "주공, 존망의 기로입니다! {threatName}이 군사포인트 {threatMP}으로 압도하고 있으며, 우리 {playerMP}으로는 정면 대결이 불가합니다." },
    ],
  },
  ...
  economy_status: {
    comfortable: [
      { text: "내정은 순조롭습니다. 시장 {marketCount}개, 농장 {farmCount}개로 턴당 {ipRegen} 내정포인트를 확보하고 있습니다." },
    ],
    stable: [
      { text: "내정 수입은 턴당 {ipRegen}으로 안정적입니다. 현재 내정포인트 {ip}/{ipCap}이옵니다." },
    ],
    adequate: [
      { text: "내정 수입은 턴당 {ipRegen}으로 보통 수준입니다. 시설 확충의 여지가 있습니다." },
    ],
    uneasy: [
      { text: "내정 수입 {ipRegen}이 다소 부족합니다. 시장 {marketCount}개, 농장 {farmCount}개로는 충분하지 않사옵니다." },
    ],
    crisis: [
      { text: "내정이 매우 취약합니다. 턴당 수입 {ipRegen}, 현재 내정포인트 {ip}로는 시설 투자가 쉽지 않습니다." },
    ],
    critical: [
  ...
  diplomacy_status: {
    ...
    adequate: [
      { text: "{threatName}과의 관계는 {threatRelationLabel}입니다. 외교포인트 {dp}로 관계 개선을 도모할 수 있습니다." },
    ],
    uneasy: [
  ...
  countermeasure_military: {
    comfortable: [
      { text: "군사적 여유가 있으니, 훈련을 실시합니다. (내정포인트 15 소비, 훈련도 +10%로 {trainTarget}% 목표)" },
    ],
    stable: [
      { text: "병력은 충분하오나, 훈련도 향상을 권합니다. (내정포인트 15 소비, 훈련도 +10%로 {trainTarget}% 목표)" },
    ],
    adequate: [
      { text: "훈련 강화가 필요합니다. 내정포인트를 투입해 훈련도를 {trainTarget}%까지 끌어올려야 합니다." },
    ],
    uneasy: [
      { text: "훈련 강화가 시급합니다. 내정포인트를 투입해 훈련도를 {trainTarget}%까지 끌어올려야 합니다." },
    ],
    crisis: [
      { text: "즉시 모병에 착수해야 합니다. 내정포인트를 최대 투입하면 {recruitTarget}명 확보 가능합니다." },
    ],
    critical: [
      { text: "일각도 지체할 수 없습니다! 즉각 모병하여 병력 {recruitTarget}명을 확보해야 합니다!" },
    ],
  },
  ...
  countermeasure_economy: {
    comfortable: [
      { text: "내정 기반이 탄탄하니, 은행을 업그레이드하여 내정포인트 상한을 높이는 것이 좋겠습니다." },
    ],
    stable: [
      { text: "시장과 농장을 추가 업그레이드하여 수입을 늘리는 것을 권합니다." },
    ],
    adequate: [
  ...
  countermeasure_diplomacy: {
    ...
    stable: [
      { text: "외교 상황은 안정적이옵니다. 외교포인트 {dp}를 비축하고 있으니, 필요 시 즉각 대응이 가능합니다." },
    ],
    adequate: [
      { text: "외교포인트 2를 투입해 {threatName}과의 관계를 개선할 것을 권합니다. (관계 +1 예상, 현재 보유 {dp})" },
    ],
    uneasy: [
      { text: "{threatName}과의 관계 개선이 필요합니다. 외교포인트 2를 즉시 투입해 수습하십시오. (관계 +1 예상)" },
    ],
    crisis: [
      { text: "{threatName}과의 관계가 최악입니다. 외교포인트 2를 즉시 투입해 관계를 개선하지 않으면 침공을 면치 못합니다." },
    ],
    critical: [
      { text: "지금 당장 {threatName}과의 외교를 수습하지 않으면 전멸을 면치 못합니다. 즉각 외교포인트를 투입하십시오!" },
    ],
  },
...
export const GUAN_YU_TEMPLATES: Partial<TemplateMap> = {
  military_status: {
    comfortable: [
      ...
      { text: "군사 상황은 만족스럽습니다. 병력 {playerTroops}, 군사포인트 {playerMP}으로 어떤 적도 두렵지 않습니다.", emotion: "excited" },
    ],
    stable: [
      { text: "병력 {playerTroops}으로 안정적이옵니다. 훈련도 {playerTraining}%를 유지하며 대비하고 있습니다.", emotion: "calm" },
    ],
    adequate: [
      { text: "병력은 {playerTroops}이나, 훈련도 {playerTraining}%가 다소 부족합니다. 훈련 강화가 필요합니다.", emotion: "thoughtful" },
      { text: "{threatName}의 군사포인트 {threatMP}에 비해 우리는 {playerMP}이옵니다. 병력 보강이 필요합니다.", emotion: "thoughtful" },
    ],
    uneasy: [
      { text: "{threatName}의 {threatMP}에 비해 우리 {playerMP}은 부족합니다. 훈련도 {playerTraining}%로는 싸우기 힘드니, 보강이 시급합니다.", emotion: "worried" },
    ],
    crisis: [
  ...
  countermeasure_military: {
    comfortable: [
      { text: "현 병력을 유지하되, 훈련을 실시합니다. (내정포인트 15 소비, 훈련도 +10%로 {trainTarget}% 목표)", emotion: "calm" },
    ],
    stable: [
      { text: "정예화에 집중합시다. 훈련을 실시합니다. (내정포인트 15 소비, 훈련도 +10%로 {trainTarget}% 목표)", emotion: "calm" },
    ],
    adequate: [
      { text: "훈련을 실시합니다. 내정포인트 15를 투입해 훈련도를 {trainTarget}%까지 높이겠습니다.", emotion: "thoughtful" },
    ],
    uneasy: [
      { text: "훈련이 시급합니다. 내정포인트 15를 투입해 훈련도를 {trainTarget}%까지 끌어올리겠습니다.", emotion: "worried" },
    ],
    crisis: [
      { text: "지금 당장 모병에 착수해야 합니다! 내정포인트를 최대 투입하면 {recruitTarget}명 확보 가능합니다!", emotion: "worried" },
    ],
    critical: [
      { text: "모든 것을 병력 확보에 집중해야 합니다! 즉각 모병하여 {recruitTarget}명을 확보하십시오!", emotion: "angry" },
    ],
  },
  ...
  request_ip_support: {
    uneasy: [
      { text: "미축, 훈련 강화에 내정포인트가 필요하오. {trainTarget}%까지 끌어올리려 하는데 지원해 줄 수 있소?", emotion: "thoughtful" },
    ],
    crisis: [
      { text: "미축, 병력 보충이 급하오! {recruitTarget}명 모병이 목표인데, 내정포인트가 얼마나 됩니까?", emotion: "worried" },
      { text: "미축! 모병에 내정포인트를 최대한 투입해야 하오. 지금 얼마나 지원할 수 있소?", emotion: "worried" },
    ],
    critical: [
      { text: "미축! 지금 당장 내정포인트를 모두 모병에 써야 하오! 얼마나 있소?", emotion: "angry" },
    ],
  },
};
...
export const MI_ZHU_TEMPLATES: Partial<TemplateMap> = {
  economy_status: {
    comfortable: [
      { text: "주공, 내정은 순조롭습니다. 시장 {marketCount}개, 농장 {farmCount}개로 턴당 {ipRegen} 내정포인트를 확보하고 있사옵니다. 현재 {ip}/{ipCap}이옵니다.", emotion: "excited" },
      { text: "재정 상황이 양호합니다. 수입 {ipRegen}, 잔액 {ip}로 어떠한 사업도 실행 가능합니다.", emotion: "calm" },
    ],
    stable: [
      { text: "내정 수입은 {ipRegen}으로 안정적입니다. 시장 {marketCount}개, 농장 {farmCount}개를 운영 중이옵니다.", emotion: "calm" },
    ],
    adequate: [
      { text: "턴당 수입 {ipRegen}으로 보통 수준입니다. {castleCount}개 성채 기준으로 시설 확충의 여지가 있습니다.", emotion: "thoughtful" },
      { text: "수입 {ipRegen}은 나쁘지 않으나, 시장 {marketCount}개, 농장 {farmCount}개 이상의 투자가 필요합니다.", emotion: "thoughtful" },
    ],
    uneasy: [
  ...
  reply_ip_to_military: {
    comfortable: [
      { text: "관우 장군, 현재 내정포인트 {ip}이옵니다. 군사 지원에 아낌없이 쓰십시오.", emotion: "calm" },
    ],
    stable: [
      { text: "관우 장군, 내정포인트 {ip} 보유 중입니다. 필요한 만큼 모병에 투입 가능합니다.", emotion: "calm" },
    ],
    adequate: [
      { text: "관우 장군, 현재 {ip} 있습니다. 모병 지원은 가능하나 시설 투자와 나눠 써야 합니다.", emotion: "thoughtful" },
      { text: "관우 장군, 내정포인트 {ip}이옵니다. 모병 우선으로 배정하되 시장 투자도 챙겨야 합니다.", emotion: "thoughtful" },
    ],
    uneasy: [
      { text: "관우 장군, 내정포인트가 {ip}으로 넉넉하지 않습니다. 모병과 시설 투자 중 우선순위를 정해야 합니다.", emotion: "worried" },
    ],
    crisis: [
      { text: "관우 장군, 내정포인트가 {ip}으로 여유가 없습니다. 방통 선생께 외교 원조를 요청하면 내정포인트를 확보할 수 있을 것이옵니다.", emotion: "worried" },
    ],
    critical: [
      { text: "관우 장군, 내정포인트가 {ip}으로 당장 지원이 불가합니다. 방통 선생의 외교 원조를 받은 뒤 모병에 쓰심이 옳을 것이옵니다.", emotion: "angry" },
    ],
  },
};
...
export const PANG_TONG_TEMPLATES: Partial<TemplateMap> = {
  diplomacy_status: {
    comfortable: [
      ...
      { text: "{threatName}과의 관계({threatRelationLabel})는 양호합니다. 외교포인트 {dp}를 비축할 여유가 있사옵니다.", emotion: "excited" },
    ],
    stable: [
      { text: "{threatName}과의 관계는 {threatRelationLabel}입니다. 현 상태를 유지하는 것이 상책이옵니다.", emotion: "calm" },
    ],
    adequate: [
      { text: "{threatName}과의 관계가 {threatRelationLabel}입니다. 외교포인트 {dp}로 관계 개선을 도모할 시기이옵니다.", emotion: "thoughtful" },
  ...
  countermeasure_diplomacy: {
    ...
    stable: [
      { text: "외교 상황은 안정적이옵니다. 외교포인트 {dp}를 보유하고 있으니, 필요 시 즉각 대응이 가능합니다.", emotion: "calm" },
    ],
    adequate: [
      { text: "외교포인트 2를 투입해 {threatName}과의 관계를 개선할 것을 권합니다. (관계 +1 예상, 현재 보유 {dp})", emotion: "thoughtful" },
    ],
    uneasy: [
      { text: "{threatName}과의 관계 개선이 시급합니다. 즉시 외교포인트 2를 투입해 관계를 개선하십시오. (관계 +1 예상)", emotion: "worried" },
    ],
    crisis: [
      { text: "지금 당장 {threatName}과 외교를 수습해야 합니다! 외교포인트 2를 즉시 투입해 관계를 개선하십시오. 그렇지 않으면 침공을 면치 못합니다.", emotion: "worried" },
    ],
    critical: [
      { text: "{threatName}의 침공이 코앞입니다! 즉각 외교포인트를 투입해 당장 관계를 수습하지 않으면 전멸입니다!", emotion: "angry" },
    ],
  },
};
