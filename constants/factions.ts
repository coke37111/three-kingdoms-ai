...
export const INITIAL_FACTIONS: Faction[] = [
  {
    ...
    castles: ["신야", "하비"],
    facilities: { market: 1, farm: 1, bank: 0 },
  ...
  },
  {
    ...
    facilities: { market: 5, farm: 5, bank: 3 },
  ...
  },
  {
    ...
    facilities: { market: 3, farm: 3, bank: 2 },
