...
> **최종 갱신**: 2026-02-17 (포인트 시스템 + 5-Phase 회의 + 성채 시스템 반영)
...
| [06-auth-and-save](./06-auth-and-save.md) | Firebase 인증, Firestore 저장, 사용자 설정 |
| [07-ui-components](./07-ui-components.md) | CSS 변수, CouncilChat, WorldStatus, 컴포넌트 구조, 스타일 규칙 |
